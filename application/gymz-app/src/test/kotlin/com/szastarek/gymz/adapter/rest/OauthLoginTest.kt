...
class OauthLoginTest : StringSpec() {
    ...
    init {
        ...
        "should login via oauth" {
            ...
            withEnvironment(
                mapOf(
                    "ZITADEL_AUTHORIZE_URL" to "$zitadelBaseUrl/oauth/v2/authorize",
                    "ZITADEL_ACCESS_TOKEN_URL" to "$zitadelBaseUrl/oauth/v2/token",
                    "ZITADEL_CALLBACK_URL" to "/auth/callback",
                ),
