...
object AllowAllAccessManager : AccessManager {
    ...
    override fun checkAll(userContext: UserContext, resources: List<Resource>, action: Action): BatchDecision =
        BatchDecision.Allow(userContext.toPrincipal(), resources, action)
}
